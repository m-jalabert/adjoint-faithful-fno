...
`model_c_2in_1out_new_channels_pressure_gradient_v1` on the exact 15-member S0 inference protocol used for every
...
The measurable gate is written beside the S0 folder as `model_c_2in_1out_new_channels_pressure_gradient_acceptance_gate.json`. This
package performs no training, selection, or checkpoint promotion.

Report content SHA-256: `6f5cc7496ec6212dc8e981399943b33a7485edc639c0b31c40ac66c6e45f332e`.
