# Trajectory-v3 pooled model, S0: S0-style Figures 3--8

This package evaluates the seed-20260724, step-7,680
checkpoint of the pooled trajectory-v3 model on the **S0** held test block
(indices 6480--8999), tau0 = 0.1 N m-2. S0 is the primary Bire-style comparison.
...
Climatology is the pointwise S0 mean over the v3 training block only.
...
Report content SHA-256: `c8a7a4574ddeb10aaf012f37045728e928290645f97bd50a850a785112b56e59`.
