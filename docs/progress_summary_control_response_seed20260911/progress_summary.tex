...
The code, configuration and trained checkpoints for both models discussed in
...
are present on the \texttt{adjoint-faithful-response-training-v1} branch;
readers reproducing the results in this report should check out that branch,
since it is the one branch on which both models presented here coexist.
