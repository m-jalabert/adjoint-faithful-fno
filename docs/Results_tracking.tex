...
All packages share the same 15 starts, the same day-2,000 truth from evaluation-only job
304735, the same baselines, reductions, and six filenames, so they are comparable field
for field.
