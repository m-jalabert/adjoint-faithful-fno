...
Report/arrays/checkpoint SHA-256 values are
...
decision instead freezes the prospectively versioned 10--30-day adjoint-readiness
gate.
...
The decision ledger now separates a mandatory 10/30-day adjoint-readiness claim from
the 90--360-day autoregressive-stability claim.  The horizon-matched short gate will
be frozen after the predictability audit and may open the mandatory response/adjoint
campaign without claiming day-90 skill; optional 90-day adjoints and the long-emulator
claim remain blocked by the long-rollout track.  No later archive is opened by this
scope correction itself.
...
C & \Fail & Job 292293 passes every ten-day group and beats both baselines at days 10/30, but fails the strict long gate at worst primary AUC/slow-lead ratios 1.462/3.634. & Freeze the prospective horizon-matched adjoint-readiness gate; keep long-rollout stability and the two-state arm parallel \\
