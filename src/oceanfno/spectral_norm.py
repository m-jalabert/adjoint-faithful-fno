...
blocks. They hold 26,739,072 of the model's 27,297,960 parameters --- 97.95 % ---
...
:class:`~oceanfno.model.ProductionFNO` with no reparameterization attached and
...
def materialized_state_dict(model: Any) -> dict[str, Any]:
    ...
    into an unmodified :class:`~oceanfno.model.ProductionFNO` and the inference
