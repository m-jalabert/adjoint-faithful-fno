...
Entry points, each driven by a frozen contract in ``config/``::
    ...
    python -m oceanfno.finetune     preflight|run              --contract ...
    python -m oceanfno.figures      finalize|preflight|run     --contract ...
    python -m oceanfno.anomaly      finalize|preflight|run     --contract ...
    python -m oceanfno.figures_ft90 finalize|preflight|run     --contract ...
    python -m oceanfno.anomaly_ft90 finalize|preflight|run     --contract ...
"""
