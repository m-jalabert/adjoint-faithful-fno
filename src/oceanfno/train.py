"""Canonical training entrypoint for the retained 2-in/1-out pressure-gradient Model C.
...
MITgcm-consistent auxiliary term. Architecture, data, rollout, optimizer
