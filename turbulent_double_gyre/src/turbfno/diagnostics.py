...
#: Degrees per grid cell, and the metres one cell spans meridionally.  Every
#: cumulative meridional integral in this module steps by *cells*, so it must be
#: this and not metres per degree: on the 1-degree grid they were equal, here
#: they differ by four and a streamfunction built on the wrong one is 4x out.
