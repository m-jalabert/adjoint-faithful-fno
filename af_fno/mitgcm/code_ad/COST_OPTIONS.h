...
C--   AF--FNO: the quantity of interest is carried by the overridden
C     cost_test.F, which computes J = sum_ij w_ij * etaN_ij(T) against a weight
C     field read at runtime from afCostWeightFile.
